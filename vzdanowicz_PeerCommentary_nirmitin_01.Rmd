---
title: "vzdanowicz_PeerCommentary_nirmitin_01"
author: "Nirmiti Naik"
...
# Peer Commentary 
<br>
1.  What I learned from running Victoria’s code is that it’s extremely beneficial to explain each of your steps leading to the final answer since her code was extremely easy to follow and extremely well formatted. Her explanations for each step alongside her code makes it easy to see why she did executed commands and her reasoning behind them. Something that will help improve my own code is making my code “prettier” and thereby more linear and organised. I was concerned with keeping the answers the main focus however Victoria's format and focus on making her code understandable is a much better approach. Comparing our results for some of the challenges was insightful because it informed me of my misunderstandings in formatting - for example, our similar results for challenge 4 suggest that list headings are written differently based on the items they contain, while I thought that list headings should be by themselves. 

2. Victoria’s code looks extremely accurate and clear however for the original code version, it could be worthwhile to note down points of confusion or how she was able to overcome the challenges she had. This could further the visualisation of her thought process however I think her code looks great. 

3. While I’m not 100% sure what Victoria’s challenges were, some challenges that may have been relevant to her coding experience for HW#1 could be having to consult external resources in order to learn how to fix certain errors. This wouldn't have been able to solved by comparison since learning the format and function of various commands involves research. 

4. Victoria’s commenting and explanations are extremely readable and interpretable since she talks through each step before she executes it and discusses why she executes certain commands. It’s great that she uses the relevant terms as well to describe the steps she took. 
